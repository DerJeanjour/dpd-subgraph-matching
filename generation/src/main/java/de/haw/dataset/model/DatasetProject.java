...
public enum DatasetProject {
    ...
    ADAPTER_EXAMPLE( DatasetType.PATTERN_EXAMPLES ),
    BUILDER_EXAMPLE( DatasetType.PATTERN_EXAMPLES ),
    FACADE_EXAMPLE( DatasetType.PATTERN_EXAMPLES ),
    FACTORY_METHOD_EXAMPLE( DatasetType.PATTERN_EXAMPLES ),
    OBSERVER_EXAMPLE( DatasetType.PATTERN_EXAMPLES ),
