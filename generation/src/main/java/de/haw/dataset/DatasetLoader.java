...
public class DatasetLoader {
    ...
    public static File load( final Dataset dataset ) {
        return switch ( dataset ) {
            ...
            case ABSTRACT_FACTORY_EXAMPLE -> load( BASE_PATH_PATTERN_EXAMPLES + "abstractfactory/" );
            case SINGLETON_EXAMPLE -> load( BASE_PATH_PATTERN_EXAMPLES + "singleton/" );
            ...
            default -> throw new IllegalArgumentException( "Dataset now supported: " + dataset );
